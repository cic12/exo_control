...
double assistanceMode(double Tau_h, double dtheta_des, double pA, double pR, double sig_h, double c_h, double sig_e, double c_e, double halt_lim) {

	// USE DDTHETA INSTEAD OF DTHETA
	double sig_hN = 5, c_hN = -7.5, sig_hP = 15, c_hP = 30;
	double sig_eN = 0.4, c_eN = -1, sig_eP = 0.4, c_eP = 1;  // using dtheta_des

	mu[0] = gaussmf(dtheta_des, sig_eN, c_eN); // dtheta N
	mu[1] = gaussmf(dtheta_des, sig_eP, c_eP); // dtheta P
