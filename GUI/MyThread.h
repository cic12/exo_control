...
struct mpcParams {
	...
	const double Tsim = 240.0, dt = 0.002;
	double Thor = 0.2;
...
struct modelParams {
	double A = 0.7129, B = 4.2936, J = 0.1744, tau_g = 6.0796, w_theta = 250000, w_tau = 25;
...
private:
	int i, vec_i;
	double previousPosition = 0.2, currentVelocity = 0, previousVelocity = 0, currentAcceleration = 0, alpha = 0.01;
