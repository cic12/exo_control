...
public:
    ...
    void setupUi(QMainWindow *GUIClass)
    {
        ...
        plot->setGeometry(QRect(480, 30, 501, 181));
        ...
        w_tau_box->setDecimals(5);
        w_tau_box->setMaximum(1000.000000000000000);
        w_tau_box->setSingleStep(0.000001000000000);
        ...
        w_theta_box->setDecimals(5);
        w_theta_box->setMaximum(1000000.000000000000000);
        w_theta_box->setSingleStep(0.000001000000000);
